...
public class XmlRpcClient extends XmlRpcParser implements XmlRpcInvocationHandler
{
     ...
     * 
     *  @param streamMessages Indicates whether to stream messages directly
    ...
    private Object endCall() throws XmlRpcException, XmlRpcFault
    {
        try
        {
            ...
            else
            {
                ...
                output.write( buffer.toString().getBytes( XmlRpcMessageBundle.getString( "XmlRpcClient.Encoding" ) ) );
                output.flush();
                output.close();
            }
        ...
        {
            throw new XmlRpcException(
                XmlRpcMessageBundle.getString( "XmlRpcClient.NetworkError" ),
                    ioe );
        }
        finally
        {
    ...
    private void handleResponse() throws XmlRpcFault
    {
        ...
        {
            throw new XmlRpcException(
                XmlRpcMessageBundle.getString( "XmlRpcClient.ParseError" ), e );
        }
